...
const boxes = [
  { title: 'CPU Traffic', value: '10%', icon: 'fas fa-cog', color: 'bg-info' },
  { title: 'Likes', value: '41,410', icon: 'far fa-thumbs-up', color: 'bg-danger' },
  { title: 'Sales', value: '760', icon: 'fas fa-shopping-cart', color: 'bg-success' },
  { title: 'New Members', value: '2,000', icon: 'fas fa-users', color: 'bg-warning' }
]
</script>
