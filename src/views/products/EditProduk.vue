            ...
            <div class="card-body">
              <div class="row g-3">
                <div class="col-md-6">
                  ...
                  <input v-model="form.nama_produk" type="text" class="form-control" :class="{'is-invalid': errors.nama_produk}" />
                ...
                <div class="col-md-6">
                  ...
                  <input v-model="form.harga" type="number" class="form-control" :class="{'is-invalid': errors.harga}" />
                  <div class="invalid-feedback">{{ errors.harga }}</div>
                </div>

                <div class="col-md-6">
                  <label class="form-label">Stok</label>
                  <input v-model="form.stok" type="number" class="form-control" :class="{'is-invalid': errors.stok}" />
                ...
                <div class="col-md-6">
                  ...
                  <select v-model="form.satuan_id" class="form-select" :class="{'is-invalid': errors.satuan_id}">
